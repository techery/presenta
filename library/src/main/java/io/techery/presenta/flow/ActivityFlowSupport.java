package io.techery.presenta.flow;
...
public final class ActivityFlowSupport {
  ...
  public static ActivityFlowSupport onCreate(NonConfigurationInstance nonConfigurationInstance,
    ...
    Preconditions.checkArgument(parceler != null, "parceler may not be null");
    Preconditions.checkArgument(defaultBackstack != null, "defaultBackstack may not be null");
  ...
  public void onResume(Flow.Dispatcher dispatcher) {
    Preconditions.checkState(flow != null, "Don't have a Flow. Did you forget to call onCreate()?");
    Preconditions.checkArgument(dispatcher != null, "dispatcher may not be null");
  ...
  public void onPause() {
    Preconditions.checkState(flow != null, "Don't have a Flow. Did you forget to call onCreate()?");
    Preconditions.checkState(dispatcher != null, "Don't have a Dispatcher. Did you forget to call onResume()?");
...
//    checkState(flow != null, "Don't have a Flow. Did you forget to call onCreate()?");
  ...
  public void onSaveInstanceState(Bundle outState) {
    Preconditions.checkArgument(outState != null, "outState may not be null");
    Preconditions.checkState(flow != null, "Don't have a Flow. Did you forget to call onCreate()?");
