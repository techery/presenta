...
import com.techery.addition.flow.util.BackSupport;
...
public class FramePathContainerView extends FrameLayout implements BackSupport.HandlesBack, PathContainerView {
  ...
  public FramePathContainerView(Context context, AttributeSet attrs) {
    this(context, attrs, new SimplePathContainer(R.id.mortar_screen_switcher_tag, Path.contextFactory()));
  }
